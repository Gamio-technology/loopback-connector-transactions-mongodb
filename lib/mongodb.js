...
MongoDB.prototype.coerceId = function(modelName, id, options) {
  // See https://github.com/strongloop/loopback-connector-transactions-mongodb/issues/206
...
MongoDB.prototype.create = function(modelName, data, options, callback) {
  ...
  this.execute(modelName, 'insertOne', data, Object.assign({safe: true}, options), function(err, result) {
    if (self.debug) {
...
MongoDB.prototype.save = function(modelName, data, options, callback) {
  ...
  this.execute(modelName, 'updateOne', {_id: oid}, {$set: data}, Object.assign({upsert: true}, options),
    function(err, result) {
      if (!err) {
...
MongoDB.prototype.exists = function(modelName, id, options, callback) {
  ...
  this.execute(modelName, 'findOne', {_id: id}, options, function(err, data) {
    if (self.debug) {
...
MongoDB.prototype.find = function find(modelName, id, options, callback) {
  ...
  this.execute(modelName, 'findOne', {_id: oid}, options, function(err, data) {
    if (self.debug) {
...
MongoDB.prototype.destroy = function destroy(modelName, id, options, callback) {
  ...
  id = self.coerceId(modelName, id, options);
  this.execute(modelName, 'deleteOne', {_id: id}, options, function(err, result) {
    if (self.debug) {
...
MongoDB.prototype.all = function all(modelName, filter, options, callback) {
  ...
  if (fields) {
    ...
    this.execute(modelName, 'find', query, Object.assign(findOpts, options), processResponse);
  } else {
...
MongoDB.prototype.destroyAll = function destroyAll(
  ...
  this.execute(modelName, 'deleteMany', where || {}, options, function(err, info) {
...
MongoDB.prototype.disconnect = function(cb) {
  ...
  at MongoDB.disconnect (node_modules/loopback-connector-transactions-mongodb/lib/mongodb.js:1660:13)
  */
  /*
  if (this.db) {
    this.db.unref();
