...
MongoDB.prototype.save = function(modelName, data, options, callback) {
  ...
  this.execute(modelName, 'updateOne', {_id: oid}, {$set: data}, Object.assign({upsert: true}, options), function(err, result) {
    if (!err) {
...
MongoDB.prototype.count = function count(modelName, where, options, callback) {
  ...
  this.execute(modelName, method, where, options, function(err, count) {
    if (self.debug) {
